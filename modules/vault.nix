# the module for enabling the vault systemd service on a NixOS system
# you can modify this to extend the nix config's flexibility, reduce
# configuration boilerplate, etc.
{
  config,
  lib,
  options,
